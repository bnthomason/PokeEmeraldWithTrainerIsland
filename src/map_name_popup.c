...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_TRAINERISLAND_ENTRANCE] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_TRAINERISLAND_FOREST] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_TRAINERISLAND_AREA1] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_TRAINERISLAND_AREA2] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_TRAINERISLAND_AREA3] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_TRAINERISLAND_AREA4] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_TRAINERISLAND_AREA5] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_TRAINERISLAND_AREA6] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_TRAINERISLAND_AREA7] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_TRAINERISLAND_AREA8] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_TRAINERISLAND_AREA9] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_TRAINERISLAND_AREA10] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_TRAINERISLAND_1F] = MAPPOPUP_THEME_STONE,
    [MAPSEC_TRAINERISLAND_2F] = MAPPOPUP_THEME_STONE,
    [MAPSEC_TRAINERISLAND_B1F] = MAPPOPUP_THEME_STONE,
    [MAPSEC_TRAINERISLAND_HALL] = MAPPOPUP_THEME_STONE,
    [MAPSEC_TRAINERISLAND_SANCTUM] = MAPPOPUP_THEME_STONE,
    [MAPSEC_TRAINERISLAND_TRAINERCITY] = MAPPOPUP_THEME_MARBLE

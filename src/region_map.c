...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_TRAINERISLAND_ENTRANCE] = {MAP_GROUP(TRAINER_ISLAND_ENTRANCE), MAP_NUM(TRAINER_ISLAND_ENTRANCE), HEAL_LOCATION_TRAINER_ISLAND_ENTRANCE},
    [MAPSEC_TRAINERISLAND_TRAINERCITY] = {MAP_GROUP(TRAINER_ISLAND_TRAINER_CITY), MAP_NUM(TRAINER_ISLAND_TRAINER_CITY), HEAL_LOCATION_TRAINER_ISLAND_TRAINER_CITY},
...
static const u16 sRedOutlineFlyDestinations[][2] =
{
	...
	{
        FLAG_VISITED_TRAINERCITY,
        MAPSEC_TRAINERISLAND_TRAINERCITY
    },
    {
        -1,
        MAPSEC_NONE
...
static u8 GetMapsecType(u16 mapSecId)
{
    ...
    case MAPSEC_TRAINERISLAND_TRAINERCITY:
        return FlagGet(FLAG_VISITED_TRAINERCITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_TRAINERISLAND_ENTRANCE:
        return FlagGet(FLAG_LANDMARK_TRAINERISLAND) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;

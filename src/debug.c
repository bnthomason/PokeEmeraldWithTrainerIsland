...
static const u8 sDebugText_PokemonEVs[] =               _("All EVs:               \n    {STR_VAR_3}            \n             \n{STR_VAR_2}          ");
static const u8 sDebugText_PokemonEV_0[] =              _("EV HP:               \n    {STR_VAR_3}            \n             \n{STR_VAR_2}          ");
static const u8 sDebugText_PokemonEV_1[] =              _("EV Attack:               \n    {STR_VAR_3}            \n             \n{STR_VAR_2}          ");
static const u8 sDebugText_PokemonEV_2[] =              _("EV Defense:               \n    {STR_VAR_3}            \n             \n{STR_VAR_2}          ");
static const u8 sDebugText_PokemonEV_3[] =              _("EV Speed:               \n    {STR_VAR_3}            \n             \n{STR_VAR_2}          ");
static const u8 sDebugText_PokemonEV_4[] =              _("EV Sp. Attack:               \n    {STR_VAR_3}            \n             \n{STR_VAR_2}          ");
static const u8 sDebugText_PokemonEV_5[] =              _("EV Sp. Defense:               \n    {STR_VAR_3}            \n             \n{STR_VAR_2}          ");
...
static const u8 sDebugText_Give_MaxPoints[] =          _("Max Points");
...
static const struct ListMenuItem sDebugMenu_Items_Give[] =
{
	...
	[DEBUG_GIVE_MENU_ITEM_MAX_POINTS]        = {sDebugText_Give_MaxPoints,          DEBUG_GIVE_MENU_ITEM_MAX_POINTS},
...
static void DebugAction_Give_Pokemon_SelectIVs(u8 taskId)
{
    ...
    if (JOY_NEW(A_BUTTON))
    {
        ...
        else
        {
			...
			StringCopyPadded(gStringVar3, gStringVar3, CHAR_SPACE, 15);
			StringExpandPlaceholders(gStringVar4, sDebugText_PokemonEV_0);
			AddTextPrinterParameterized(gTasks[taskId].data[2], 1, gStringVar4, 1, 1, 0, NULL);
...
static void DebugAction_Give_Pokemon_SelectEVs(u8 taskId)
{
    if (JOY_NEW(DPAD_ANY))
    {
        ...
        case 0:
            ...
            break;
        case 1:
            StringExpandPlaceholders(gStringVar4, sDebugText_PokemonEV_1);
            break;
        case 2:
            StringExpandPlaceholders(gStringVar4, sDebugText_PokemonEV_2);
            break;
        case 3:
            StringExpandPlaceholders(gStringVar4, sDebugText_PokemonEV_3);
            break;
        case 4:
            StringExpandPlaceholders(gStringVar4, sDebugText_PokemonEV_4);
            break;
        case 5:
            StringExpandPlaceholders(gStringVar4, sDebugText_PokemonEV_5);
            break;
        }
        AddTextPrinterParameterized(gTasks[taskId].data[2], 1, gStringVar4, 1, 1, 0, NULL);
    }

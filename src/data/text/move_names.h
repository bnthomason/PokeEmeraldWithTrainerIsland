const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] =
{
	...
	[MOVE_TRILL] = _("Trill"),
	[MOVE_LIGHTSPARK] = _("Light Spark"),
	[MOVE_FLASH_GLEAM] = _("Flash Gleam"),
	[MOVE_WINDSTORM] = _("Windstorm"),
	[MOVE_ALICORN_CHARGE] = _("AlicornChrge"),
	[MOVE_LIGHT_PULSE] = _("Light Pulse"),
	[MOVE_HEALING_TOUCH] = _("HealingTouch"),
	[MOVE_FEATHERSTORM] = _("FeatherStorm"),
	[MOVE_PHOTON_BLAST] = _("Photon Blast"),
	[MOVE_LIGHT_OF_REVIVAL] = _ ("LghtofRevivl"),
};

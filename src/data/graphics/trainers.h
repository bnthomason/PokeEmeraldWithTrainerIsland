...
const u32 gTrainerFrontPic_YoungGirl[] = INCBIN_U32("graphics/trainers/front_pics/young_girl_front_pic.4bpp.lz");
const u32 gTrainerPalette_YoungGirl[] = INCBIN_U32("graphics/trainers/palettes/young_girl.gbapal.lz");

const u32 gTrainerFrontPic_YoungBoy[] = INCBIN_U32("graphics/trainers/front_pics/young_boy_front_pic.4bpp.lz");
const u32 gTrainerPalette_YoungBoy[] = INCBIN_U32("graphics/trainers/palettes/young_boy.gbapal.lz");

...
// Plates
    ...
    {
        .name = _("Bright Plate"),
        .itemId = ITEM_BRIGHT_PLATE,
        .price = 1000,
        .holdEffect = HOLD_EFFECT_PLATE,
        .holdEffectParam = 20,
        .description = sBrightPlateDesc,
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
...
// Memories
    ...
    {
        .name = _("Light Memory"),
        .itemId = ITEM_LIGHT_MEMORY,
        .price = 1000,
        .holdEffect = HOLD_EFFECT_MEMORY,
        .holdEffectParam = 0,
        .description = sLightMemoryDesc,
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .secondaryId = TYPE_LIGHT,
...
// Mega Stones
    ...
    {
        .name = _("Holy Halo"),
        .itemId = ITEM_HOLY_HALO,
        .price = 0,
        .holdEffect = HOLD_EFFECT_HOLY_HALO,
        .description = sHolyHaloDesc,
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 80,
    ...
    [ITEM_CHAOS_CROSS] =
    {
        ...
        .itemId = ITEM_HOLY_HALO,
        .price = 0,
        .holdEffect = HOLD_EFFECT_CHAOS_CROSS,
        .description = sHolyHaloDesc,
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
...
// Gems
    ...
    {
        .name = _("Fairy Gem"),
        .itemId = ITEM_LIGHT_GEM,
        .price = 4000,
        .holdEffect = HOLD_EFFECT_GEMS,
        .holdEffectParam = 30,
        .description = sLightGemDesc,
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .secondaryId = TYPE_LIGHT,
...
// Z-Crystals
    ...
    {
        .name = _("Lightium Z"),
        .itemId = ITEM_LIGHTIUM_Z,
        .price = 0,
        .holdEffect = HOLD_EFFECT_Z_CRYSTAL,
        .description = sLightiumZDesc,
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .secondaryId = TYPE_LIGHT
...
// Type-boosting Held Items
    ...
    [ITEM_RAINBOW_PRISM] =
    {
        .name = _("Rainbow Prism"),
        .itemId = ITEM_RAINBOW_PRISM,
        .price = 2000,
        .holdEffect = HOLD_EFFECT_LIGHT_POWER,
        .holdEffectParam = 20,
        .description = sRainbowPrismDesc,
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 30,
...
// Story Key Items
    ...
    [ITEM_POINT_TRACKER] =
    {
        .name = _("Point Tracker"),
        .itemId = ITEM_POINT_TRACKER,
        .price = 0,
        .description = sPointTrackerDesc,
        .importance = 1,
        .pocket = POCKET_KEY_ITEMS,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_PointTracker,
    },

    [ITEM_BATTLE_READER] =
    {
        .name = _("Battle Reader"),
    ...
    [ITEM_RYUKU_ISLAND_TICKET] =
    {
        .name = _("RyukuIslTcket"),
        .itemId = ITEM_RYUKU_ISLAND_TICKET,
        .price = 0,
        .description = sRyukuIslandTicketDesc,
        .importance = 1,
        .pocket = POCKET_KEY_ITEMS,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,

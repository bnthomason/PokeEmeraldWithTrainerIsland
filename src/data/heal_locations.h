static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_TRAINER_ISLAND_ENTRANCE - 1] = {MAP_GROUP(TRAINER_ISLAND_ENTRANCE), MAP_NUM(TRAINER_ISLAND_ENTRANCE), 13, 17},
    [HEAL_LOCATION_TRAINER_ISLAND_TRAINER_CITY - 1] = {MAP_GROUP(TRAINER_ISLAND_TRAINER_CITY), MAP_NUM(TRAINER_ISLAND_TRAINER_CITY), 22, 26},
    [HEAL_LOCATION_RYUKYUAN_ISLAND_CITY - 1] = {MAP_GROUP(RYUKYUAN_ISLAND_CITY), MAP_NUM(RYUKYUAN_ISLAND_CITY), 34, 28},
};

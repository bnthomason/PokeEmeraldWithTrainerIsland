...
static const struct FormChange sArceusFormChangeTable[] = {
    ...
    {FORM_ITEM_HOLD_ABILITY, SPECIES_ARCEUS_LIGHT,    ITEM_BRIGHT_PLATE,  ABILITY_MULTITYPE},
    {FORM_ITEM_HOLD_ABILITY, SPECIES_ARCEUS_LIGHT,    ITEM_LIGHTIUM_Z,   ABILITY_MULTITYPE},
   {FORM_CHANGE_END},
};
...
static const struct FormChange sSilvallyFormChangeTable[] = {
    ...
    {FORM_ITEM_HOLD_ABILITY, SPECIES_SILVALLY_LIGHT,    ITEM_LIGHT_MEMORY,    ABILITY_RKS_SYSTEM},
    {FORM_CHANGE_END},
};

const u8 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_YOUNG_GIRL] = TRAINER_PIC_YOUNG_GIRL,
	[FACILITY_CLASS_YOUNG_BOY] = TRAINER_PIC_YOUNG_BOY,
};
...
const u8 gFacilityClassToTrainerClass[] =
{
    ...
    [FACILITY_CLASS_YOUNG_GIRL] = TRAINER_CLASS_YOUNG_GIRL,
	[FACILITY_CLASS_YOUNG_BOY] = TRAINER_CLASS_YOUNG_BOY,
};

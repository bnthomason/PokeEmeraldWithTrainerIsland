...
static const struct LevelUpMove sDracocerosChildLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_HORN_ATTACK),
    LEVEL_UP_MOVE( 1, MOVE_TRILL),
    LEVEL_UP_MOVE( 1, MOVE_RECOVER),
    LEVEL_UP_MOVE( 1, MOVE_SING),
	LEVEL_UP_MOVE( 3, MOVE_FLASH),
    LEVEL_UP_MOVE( 3, MOVE_LIGHTSPARK),
    LEVEL_UP_MOVE( 6, MOVE_FLY),
    LEVEL_UP_MOVE( 6, MOVE_SUNNY_DAY),
    LEVEL_UP_MOVE(10, MOVE_GUST),
    LEVEL_UP_MOVE(10, MOVE_FLASH_GLEAM),
    LEVEL_UP_MOVE(15, MOVE_WINDSTORM),
    LEVEL_UP_MOVE(21, MOVE_ALICORN_CHARGE),
    LEVEL_UP_MOVE(28, MOVE_LIGHT_PULSE),
    LEVEL_UP_MOVE(36, MOVE_HORN_DRILL),
    LEVEL_UP_MOVE(45, MOVE_HEALING_TOUCH),
    LEVEL_UP_MOVE(55, MOVE_FEATHERSTORM),
    LEVEL_UP_MOVE(66, MOVE_SOLAR_BEAM),
    LEVEL_UP_MOVE(78, MOVE_HURRICANE),
    LEVEL_UP_MOVE(91, MOVE_PHOTON_BLAST),
    LEVEL_UP_END
};

static const struct LevelUpMove sDracocerosJuvenileLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_HORN_ATTACK),
    LEVEL_UP_MOVE( 1, MOVE_TRILL),
    LEVEL_UP_MOVE( 1, MOVE_RECOVER),
    LEVEL_UP_MOVE( 1, MOVE_SING),
	LEVEL_UP_MOVE( 1, MOVE_FLASH),
    LEVEL_UP_MOVE( 1, MOVE_LIGHTSPARK),
    LEVEL_UP_MOVE( 1, MOVE_FLY),
    LEVEL_UP_MOVE( 1, MOVE_SUNNY_DAY),
    LEVEL_UP_MOVE( 1, MOVE_GUST),
    LEVEL_UP_MOVE( 1, MOVE_FLASH_GLEAM),
    LEVEL_UP_MOVE( 1, MOVE_WINDSTORM),
    LEVEL_UP_MOVE(25, MOVE_ALICORN_CHARGE),
    LEVEL_UP_MOVE(35, MOVE_LIGHT_PULSE),
    LEVEL_UP_MOVE(45, MOVE_HORN_DRILL),
    LEVEL_UP_MOVE(55, MOVE_HEALING_TOUCH),
    LEVEL_UP_MOVE(65, MOVE_FEATHERSTORM),
    LEVEL_UP_MOVE(75, MOVE_SOLAR_BEAM),
    LEVEL_UP_MOVE(85, MOVE_HURRICANE),
    LEVEL_UP_MOVE(95, MOVE_PHOTON_BLAST),
    LEVEL_UP_END
};

static const struct LevelUpMove sDracocerosAdultLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_HORN_ATTACK),
    LEVEL_UP_MOVE( 1, MOVE_TRILL),
    LEVEL_UP_MOVE( 1, MOVE_RECOVER),
    LEVEL_UP_MOVE( 1, MOVE_SING),
    ...
    LEVEL_UP_MOVE( 1, MOVE_FLASH_GLEAM),
    LEVEL_UP_MOVE( 1, MOVE_WINDSTORM),
    LEVEL_UP_MOVE( 1, MOVE_ALICORN_CHARGE),
    LEVEL_UP_MOVE( 1, MOVE_LIGHT_PULSE),
    LEVEL_UP_MOVE( 1, MOVE_HORN_DRILL),
    LEVEL_UP_MOVE( 1, MOVE_HEALING_TOUCH),
    LEVEL_UP_MOVE(66, MOVE_FEATHERSTORM),
    LEVEL_UP_MOVE(77, MOVE_SOLAR_BEAM),
    LEVEL_UP_MOVE(88, MOVE_HURRICANE),
    LEVEL_UP_MOVE(99, MOVE_PHOTON_BLAST),
    LEVEL_UP_END
};

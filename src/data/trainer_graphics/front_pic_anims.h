...
static const union AnimCmd *const sAnims_YoungGirl[] ={
    sAnim_GeneralFrame0,
};

static const union AnimCmd *const sAnims_YoungBoy[] ={
    sAnim_GeneralFrame0,
};
...
const union AnimCmd *const *const gTrainerFrontAnimsPtrTable[] =
{
    ...
    [TRAINER_PIC_YOUNG_GIRL] = sAnims_YoungGirl,
    [TRAINER_PIC_YOUNG_BOY] = sAnims_YoungBoy,
};

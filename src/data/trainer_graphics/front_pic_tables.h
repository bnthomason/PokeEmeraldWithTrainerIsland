const struct MonCoords gTrainerFrontPicCoords[] =
{
    ...
    [TRAINER_PIC_YOUNG_BOY] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_YOUNG_GIRL] = {.size = 8, .y_offset = 1}
};
...
const struct CompressedSpriteSheet gTrainerFrontPicTable[] =
{
    ...
    TRAINER_SPRITE(YOUNG_GIRL, gTrainerFrontPic_YoungGirl, 0x800),
    TRAINER_SPRITE(YOUNG_BOY, gTrainerFrontPic_YoungBoy, 0x800),
};
...
const struct CompressedSpritePalette gTrainerFrontPicPaletteTable[] =
{
    ...
    TRAINER_PAL(YOUNG_GIRL, gTrainerPalette_YoungGirl),
    TRAINER_PAL(YOUNG_BOY, gTrainerPalette_YoungBoy),
};

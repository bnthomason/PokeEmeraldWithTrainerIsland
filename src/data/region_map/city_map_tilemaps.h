...
const u32 gPokenavCityMap_TrainerCity_0[] = INCBIN_U32("graphics/pokenav/region_map/city_maps/trainercity_0.bin.lz");
const u32 gPokenavCityMap_Ryuku_City[] = INCBIN_U32("graphics/pokenav/region_map/city_maps/ryukucity.bin.lz");
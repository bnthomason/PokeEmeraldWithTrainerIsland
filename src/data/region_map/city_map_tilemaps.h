...
const u32 gPokenavCityMap_TrainerCity_0[] = INCBIN_U32("graphics/pokenav/city_maps/trainercity_0.bin.lz");
const u32 gPokenavCityMap_RyuKyuanCity[] = INCBIN_U32("graphics/pokenav/city_maps/ryukyuancity.bin.lz");

const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(DRACOCEROS_CHILD, gMonFrontPic_Dracoceros_Child),
    SPECIES_SPRITE(DRACOCEROS_JUVENILE, gMonFrontPic_Dracoceros_Juvenile),
    SPECIES_SPRITE(DRACOCEROS_ADULT, gMonFrontPic_Dracoceros_Adult),
#endif
    ...
    SPECIES_SPRITE(CASTFORM_WINDY, gMonFrontPic_CastformWindy),
    ...
    SPECIES_SPRITE(ARCEUS_LIGHT, gMonFrontPic_Arceus),
    ...
    SPECIES_SPRITE(SILVALLY_LIGHT, gMonFrontPic_Silvally),

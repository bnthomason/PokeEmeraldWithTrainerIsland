const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(DRACOCEROS_CHILD, gMonPalette_Dracoceros_Child),	
    SPECIES_PAL(DRACOCEROS_JUVENILE, gMonPalette_Dracoceros_Juvenile),
    SPECIES_PAL(DRACOCEROS_ADULT, gMonPalette_Dracoceros_Adult),
    ...
    SPECIES_PAL(CASTFORM_WINDY, gMonPalette_CastformWindy),
    ...
    SPECIES_PAL(ARCEUS_LIGHT, gMonPalette_ArceusLight),
#endif
    ...
    SPECIES_PAL(SILVALLY_LIGHT, gMonPalette_SilvallyLight),

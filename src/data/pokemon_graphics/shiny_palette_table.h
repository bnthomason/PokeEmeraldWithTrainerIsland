const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
	...
	SPECIES_SHINY_PAL(DRACOCEROS_CHILD, gMonShinyPalette_Dracoceros_Child),	
    SPECIES_SHINY_PAL(DRACOCEROS_JUVENILE, gMonShinyPalette_Dracoceros_Juvenile),
    SPECIES_SHINY_PAL(DRACOCEROS_ADULT, gMonShinyPalette_Dracoceros_Adult),
	#endif
    ...
    SPECIES_SHINY_PAL(CASTFORM_WINDY, gMonShinyPalette_CastformWindy),
    ...
    SPECIES_SHINY_PAL(ARCEUS_LIGHT, gMonShinyPalette_ArceusLight),
#endif
#if P_GEN_5_POKEMON == TRUE
    ...
    SPECIES_SHINY_PAL(SILVALLY_LIGHT, gMonShinyPalette_SilvallyLight),

...
static const struct TrainerBattleParameter sDoubleNoIntroBattleParams[] =
{
    {&sTrainerBattleMode,           TRAINER_PARAM_LOAD_VAL_8BIT},
    {&gTrainerBattleOpponent_A,     TRAINER_PARAM_LOAD_VAL_16BIT},
    {&sTrainerObjectEventLocalId,   TRAINER_PARAM_LOAD_VAL_16BIT},
...
static const struct TrainerBattleParameter sTrainerBContinueScriptDoubleBattleParams[] =
{
    {&sTrainerBattleMode,           TRAINER_PARAM_LOAD_VAL_8BIT},
    {&gTrainerBattleOpponent_A,     TRAINER_PARAM_LOAD_VAL_16BIT},
    {&sTrainerObjectEventLocalId,   TRAINER_PARAM_LOAD_VAL_16BIT},
...
static const struct TrainerBattleParameter sContinueScriptNoIntroDoubleBattleParams[] =
{
    {&sTrainerBattleMode,           TRAINER_PARAM_LOAD_VAL_8BIT},
    {&gTrainerBattleOpponent_A,     TRAINER_PARAM_LOAD_VAL_16BIT},
    {&sTrainerObjectEventLocalId,   TRAINER_PARAM_LOAD_VAL_16BIT},
...
const u8 *BattleSetup_ConfigureTrainerBattle(const u8 *data)
{
	...
	case TRAINER_BATTLE_DOUBLE_NO_INTRO_TEXT:
        TrainerBattleLoadArgs(sDoubleNoIntroBattleParams, data);
        return EventScript_DoNoIntroDoubleTrainerBattle;		
    ...
    case TRAINER_BATTLE_CONTINUE_SCRIPT_DOUBLE_NO_MUSIC:
        ...
        SetMapVarsToTrainer();
        return EventScript_TryDoDoubleTrainerBattle;
	case TRAINER_BATTLE_CONTINUE_SCRIPT_DOUBLE_NO_MUSIC_NO_INTRO_TEXT:
        TrainerBattleLoadArgs(sContinueScriptNoIntroDoubleBattleParams, data);
        SetMapVarsToTrainer();
        return EventScript_TryDoNoIntroDoubleTrainerBattle;;
	case TRAINER_BATTLE_CONTINUE_SCRIPT_DOUBLE_NO_INTRO_TEXT:
		TrainerBattleLoadArgs(sContinueScriptNoIntroDoubleBattleParams, data);
        SetMapVarsToTrainer();
		return EventScript_TryDoNoIntroDoubleTrainerBattle;

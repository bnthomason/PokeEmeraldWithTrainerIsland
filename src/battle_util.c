...
//   normal  fight   flying  poison  ground  rock    bug     ghost   steel   mystery fire    water   grass  electric psychic ice     dragon  dark    fairy	 light
    ...
    {X(1.0), X(1.0), X(2.0), X(1.0), X(2.0), X(1.0), X(1.0), X(1.0), X(0.5), X(1.0), X(2.0), X(2.0), X(2.0), X(2.0), X(0.5), X(2.0), X(2.0), X(2.0), X(2.0), X(2.0)}, // dragon
    #if B_STEEL_RESISTANCES >= GEN_6
    ...
    {X(1.0), X(2.0), X(1.0), X(2.0), X(1.0), X(1.0), X(1.0), X(0.5), X(0.5), X(1.0), X(0.5), X(1.0), X(0.5), X(1.0), X(1.0), X(1.0), X(2.0), X(2.0), X(1.0), X(0.5)}, // light
};

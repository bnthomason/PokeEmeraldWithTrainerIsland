...
static const u16 sSpeciesToNationalPokedexNum[NUM_SPECIES - 1] =
{
	...
	SPECIES_TO_NATIONAL(DRACOCEROS_CHILD),
	SPECIES_TO_NATIONAL(DRACOCEROS_JUVENILE),
	SPECIES_TO_NATIONAL(DRACOCEROS_ADULT),
#endif
...
//Hisuian Forms
    ...
    [SPECIES_CASTFORM_WINDY - 1] = NATIONAL_DEX_CASTFORM,
    // Deoxys
...
#endif
{
    ...
    [SPECIES_ARCEUS_LIGHT - 1]    = ANIM_CIRCULAR_VIBRATE,
    ...
    [SPECIES_SILVALLY_LIGHT - 1]            = ANIM_V_SHAKE,

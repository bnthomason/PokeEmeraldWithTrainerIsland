...
//Item Definitions for gEvolutionTable
	...
	#define ITEM_BRIGHT_PLATE        10070		
	...
	#define ITEM_LIGHTIUM_Z			 10105
    #define ITEM_DOUSE_DRIVE         10106
    #define ITEM_SHOCK_DRIVE         10107
    #define ITEM_BURN_DRIVE          10108
    #define ITEM_CHILL_DRIVE         10109
    #define ITEM_BUG_MEMORY          10110
    #define ITEM_DARK_MEMORY         10111
    #define ITEM_DRAGON_MEMORY       10112
    #define ITEM_ELECTRIC_MEMORY     10113
    #define ITEM_FAIRY_MEMORY        10114
    #define ITEM_FIGHTING_MEMORY     10115
    #define ITEM_FIRE_MEMORY         10116
    #define ITEM_FLYING_MEMORY       10117
    #define ITEM_GHOST_MEMORY        10118
    #define ITEM_GRASS_MEMORY        10119
    #define ITEM_GROUND_MEMORY       10120
    #define ITEM_ICE_MEMORY          10121
	#define ITEM_LIGHT_MEMORY		 10122
    #define ITEM_POISON_MEMORY       10123
    #define ITEM_PSYCHIC_MEMORY      10124
    #define ITEM_ROCK_MEMORY         10125
    #define ITEM_STEEL_MEMORY        10126
    #define ITEM_WATER_MEMORY        10127

    //FORM_ITEM_USE
    #define ITEM_GRACIDEA            10128
    // #define ITEM_REVEAL_GLASS        10129
    // #define ITEM_PRISON_BOTTLE       10130
    #define ITEM_RED_NECTAR          10131
    #define ITEM_YELLOW_NECTAR       10132
    #define ITEM_PINK_NECTAR         10133
    #define ITEM_PURPLE_NECTAR       10134

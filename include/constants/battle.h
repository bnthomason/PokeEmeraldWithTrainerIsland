...
#define B_WEATHER_WINDSTORM_TEMPORARY      (1 << 12)
#define B_WEATHER_WINDSTORM_PERMANENT      (1 << 13)
#define B_WEATHER_WINDSTORM            (B_WEATHER_WINDSTORM_TEMPORARY | B_WEATHER_WINDSTORM_PERMANENT | B_WEATHER_STRONG_WINDS)
#define B_WEATHER_ANY                 (B_WEATHER_RAIN | B_WEATHER_SANDSTORM | B_WEATHER_SUN | B_WEATHER_HAIL | B_WEATHER_WINDSTORM)
...
#define ENUM_WEATHER_WINDSTORM			  8
...
#define MOVE_EFFECT_CURSE				0x4B
#define MOVE_EFFECT_ATTRACT				0x4C

#define NUM_MOVE_EFFECTS                0x4D
